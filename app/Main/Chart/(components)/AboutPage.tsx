...
const AboutPage = (): JSX.Element => {
  return (
    <div>
      ...
      <main className="flex flex-row w-5/6 items-center justify-center absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div className="card card-side bg-base-100 shadow-xl">
          ...
          <div className="flex flex-start w-52 card-body">
            ...
            <div className="card-actions justify-end">
              <button className="btn bg-primary w-3/6">
              ...
              <button className="btn bg-green-500 w-3/6">
